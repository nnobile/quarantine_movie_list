...
class API
  ...
  def self.retrieve_movies
    api_key = "api_key=3cb858a27ba1fcb6f33f21f11e03295a"
    url = "https://api.themoviedb.org/3/discover/movie?#{api_key}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false"
    uri = URI(url)
